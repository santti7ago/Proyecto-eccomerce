package com.lulopet.ecommerce.infrastructure.dto;

import com.lulopet.ecommerce.domain.User;
import com.lulopet.ecommerce.domain.UserType;
...
public class UserDto {
    ...
    public User userDtoToUser(){
        return new User(null,this.getEmail(),this.getFirstName(),
                this.getLastName(),this.getEmail(), this.getAddress(),
                this.getCellphone(), this.getPassword(), UserType.USER,
                LocalDateTime.now());
    }
}
